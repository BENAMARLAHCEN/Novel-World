                ...
                <div class="col-lg-6 col-md-8">
                    <div class="">
                        ...
                        <ul class="header-action btns-inline">
                            <li><a href="" class="btn btn-primary btn-sm">Read First Chapter</a></li>
...
<section class="section section-tesimonial bg-lighter" id="reviews">
    <div class="container">
        <div class="d-flex justify-content-between align-items-center">
            ...
            <div class="">
                <div class="section-head">
                    <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalForm">Write a Review</button>
                </div>
